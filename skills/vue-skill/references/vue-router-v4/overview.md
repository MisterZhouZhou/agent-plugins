...
This reference is organized to match the Vue Router official documentation structure (https://router.vuejs.org/guide/, https://router.vuejs.org/api/). When working with Vue Router:
...
3. **Follow the specific instructions** in that reference file for syntax, structure, and best practices
...
This reference includes detailed examples organized to match the Vue Router official documentation structure (https://router.vuejs.org/guide/, https://router.vuejs.org/api/). All examples are in the `examples/` directory, organized by topic:
