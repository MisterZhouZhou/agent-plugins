...
BASE_URL_ENV_VAR = "XAI_API_BASE_URL"
DEFAULT_IMAGE_MODEL = "grok-imagine-image"
DEFAULT_VIDEO_MODEL = "grok-imagine-video"
IMAGE_MODEL_ENV_VAR = "XAI_IMAGE_MODEL"
VIDEO_MODEL_ENV_VAR = "XAI_VIDEO_MODEL"
...
class GrokImagineVideoClient:
    ...
    def __init__(
        ...
        Args:
            ...
            base_url: API base URL. Defaults to XAI_API_BASE_URL or https://api.x.ai/v1
            image_model: Image model name. Defaults to XAI_IMAGE_MODEL or grok-imagine-image
            video_model: Video model name. Defaults to XAI_VIDEO_MODEL or grok-imagine-video
        """
        self.api_key = api_key
        self.base_url = (base_url or os.getenv(BASE_URL_ENV_VAR) or DEFAULT_BASE_URL).rstrip("/")
        self.image_model = image_model or os.getenv(IMAGE_MODEL_ENV_VAR) or DEFAULT_IMAGE_MODEL
        self.video_model = video_model or os.getenv(VIDEO_MODEL_ENV_VAR) or DEFAULT_VIDEO_MODEL
        self.headers = {
